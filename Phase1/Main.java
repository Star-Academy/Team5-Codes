public class Main {
    ...
    // .contains("block this set, cuz there is no search result common between all
    // of the words.")) {
    ...
    // private static void modifySets(String[] splitInput, Tokenizer data,
    // Set<String> answer, Set<String> negativeSet,
    ...
    // */
    // private static void updateResultOfNoSignedWords(Tokenizer data, Set<String>
    // noSignSet, String wordToSearch) {
    // if (noSignSet.contains("block this set, cuz there is no search result common
    // between all of the words."))
    // return;
    // if (noSignSet.isEmpty() &&
    // data.getInvertedIndexMap().containsKey(wordToSearch.toLowerCase())) {
    ...
    // data.getInvertedIndexMap().get(wordToSearch.toLowerCase());
    // if (result == null) {
    // noSignSet.clear();
    // noSignSet.add("block this set, cuz there is no search result common between
    // all of the words.");
    // return;
    // }
    ...
    // * @param wordToSearchWithoutSign is the word that we want to search for in
    // our
    // * data.
    // */
    // private static void updateResultForAppropriateSet(Tokenizer data, Set<String>
    // answer,
    // String wordToSearchWithoutSign) {
    // if
    // (data.getInvertedIndexMap().containsKey(wordToSearchWithoutSign.toLowerCase()))
